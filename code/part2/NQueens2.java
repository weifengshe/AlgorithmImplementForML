...
public class NQueens2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < numIterations; i ++){
	        ...
	        // simulated annealing
	        SimulatedAnnealing sa = new SimulatedAnnealing(100, .25, hcp);
	        ...
	        StandardGeneticAlgorithm ga = new StandardGeneticAlgorithm(250, 150, 25, gap);
	        ...
	        MIMIC mimic = new MIMIC(250, 75, pop);
