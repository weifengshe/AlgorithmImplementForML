...
public class Knapsack2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //int[] iterations = {1, 2, 5, 10, 20, 50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000,1500, 2000, 3000};
        //int numIterations = iterations.length;
        int numIterations = 50;
        String outputDir = "/Users/craiglab/Documents/ml";
        String winner = "";
        ...
        for (int i=0; i < numIterations; i++) {
            ...
            RHCTrainingTimes[i] = (end - start)/Math.pow(10,9);
            RHCTrialBests[i] = ef.value(rhc.getOptimal());
            if(ef.value(rhc.getOptimal()) > RHCBest){
                RHCBest = ef.value(rhc.getOptimal());
            }
            System.out.println("RHC BEST: " + ef.value(rhc.getOptimal()));
            System.out.println("RHC TRAINING TIME: " + RHCTrainingTimes[i]);
            ...
            MIMIC mimic = new MIMIC(250, 100, pop);
