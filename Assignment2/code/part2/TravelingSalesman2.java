...
public class TravelingSalesman2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i=0; i < numIterations; i++) {
            ...
            //simulated annealing
	        SimulatedAnnealing sa = new SimulatedAnnealing(1E12, .72, hcp);
            ...
            // Genetic Algorithm
            StandardGeneticAlgorithm ga = new StandardGeneticAlgorithm(250, 120, 18, gap);
	        ...
	        MIMIC mimic = new MIMIC(210, 10, pop);
