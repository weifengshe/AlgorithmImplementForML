package opt.test;
/** only change the population of Genetic algorithm;*/
import java.io.*;
 ...
 * @version 1.0
 */
public class KnapsackTestGAPopulation {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i=0; i < numIterations; i++) {
            ...
            StandardGeneticAlgorithm ga = new StandardGeneticAlgorithm(popu, 150, 25, gap);
