package opt.test;
/** only change the tomutate parameter of Genetic algorithm;*/
import java.io.*;
 ...
 * @version 1.0
 */
public class KnapsackTestGATomutate {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[] tomutate = new int[numIterations];
        tomutate[0] = 1;
        ...
        for (int i=0; i < numIterations; i++) {
            ...
            StandardGeneticAlgorithm ga = new StandardGeneticAlgorithm(400, 150, mutate, gap);
            ...
            System.out.println("POPULATION: " + tomutate[i]);
       ...
       File file = new File(outputDir + new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss").format(new Date()) + "_Results.csv");
        ...
        pwtr.println("TOMUTATE, GA SCORE, GA TRAINING TIME");
        ...
        for(int i = 0; i < numIterations; i++) {
        	...
        	pwtr.println(tomutate[i] + "," + GATrialBests[i] + "," + GATrainingTimes[i]);
        }
        pwtr.println();
